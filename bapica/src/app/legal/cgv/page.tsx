      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>Bapica propose une plateforme multi-agents IA pour PME et indépendants. Les agents disponibles varient selon la formule (Essentiel 8 agents ou Pro 13 agents). Bapica s&apos;engage à mettre en œuvre les moyens nécessaires pour assurer la continuité du service.</p>
