  ...
  return {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Bapica propose deux formules : Essentiel à 49€/mois avec 4 agents (Général, Support, Contenu, Téléphonique) et Pro à 79€/mois avec 12 agents + appels téléphoniques (0,20€/min) + analytics + onboarding personnalisé.",
        },
      },
      {
        "@type": "Question",
