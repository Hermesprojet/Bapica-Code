...
const AGENTS: AgentConfig[] = [
  {
    ...
    name: 'Agent Général',
    persona: 'Léo',
    description: "Point d'entrée unique : connaît ton profil, diagnostique tes leviers de croissance et coordonne tous les agents.",
  ...
  },
  {
    ...
    persona: 'Camille',
    description: 'Audit SEO (ton site et ceux des concurrents), articles optimisés, calendrier éditorial, publication CMS.',
    model: 'claude-haiku-4',
    temperature: 0.7,
    maxTokens: 2000,
    minPlan: 'essential',
  ...
  },
  {
    ...
    name: 'Closer Vocal',
    persona: 'Nadia',
    description: "Appels de qualification et closing, argumentaires sur mesure, traitement d'objections, résumé après chaque appel.",
    model: 'claude-haiku-4',
    temperature: 0.5,
    maxTokens: 2000,
    minPlan: 'essential',
