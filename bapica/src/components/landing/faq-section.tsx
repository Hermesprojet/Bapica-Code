...
const faqs = [
  ...
  },
  {
    ...
    a: "Notre plateforme propose jusqu'à 10 agents spécialisés couvrant tous les aspects de votre activité, le tout dans une interface unifiée. Pas besoin de jongler entre 5 outils différents.",
  },
  {
