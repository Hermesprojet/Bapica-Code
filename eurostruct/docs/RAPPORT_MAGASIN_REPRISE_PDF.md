...
|---|---|---|
| `./run_tests.sh --require-db` | **0** | `COMPLET`, 6 surfaces, API 354 collectés / 354 exécutés |
...
| `db/test/parcours_livrable.sh` | **0** | HTML **et** PDF produits, téléchargés et vérifiés par les boutons |
