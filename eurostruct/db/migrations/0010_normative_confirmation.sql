...
begin
  ...
  if n <> 3 then
    raise exception
      ...
      'd''autorite sur 3: il ne pourrait pas restituer tous les emprunts.',
      d_nom, n using errcode = 'insufficient_privilege';
  end if;
...
begin
  ...
  if n <> 3 then
    raise exception
      ...
      'd''autorite sur 3.', plan_nom, n using errcode = 'insufficient_privilege';
  end if;
