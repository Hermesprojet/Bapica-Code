...
ctl -v esc_v="$MANIF" -tAc "select normative_finalize_deployment(:'esc_v')" >/dev/null 2>&1
...
REFI=$(b -d "$BASE" -v esc_v="$MANIF_B" -tAc "select normative_finalize_deployment(:'esc_v')" 2>&1)
