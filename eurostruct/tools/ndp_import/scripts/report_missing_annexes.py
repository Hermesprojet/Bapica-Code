...
def main(argv: list[str]) -> int:
    ...
    if cc == "FR":
        ...
        print("  EN 1996-1-x    P 10-611-1 / 612-1           (maconnerie)")
        print()
        ...
        print("     P 10 maconnerie. L'acier et le mixte partagent P 22, le")
        print("     bois et la maconnerie ont chacun la leur.")
        print()
