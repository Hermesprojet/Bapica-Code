...
def main(argv: list[str]) -> int:
    ...
    if cc == "BE":
        ...
        print("CORRECTION d'une affirmation precedente: le NBN attribue bien")
        print("un indice de classement — « B 51 », « B 03 » — visible sur les")
        print("couvertures 2007-2013. Il est bien plus LARGE que l'indice")
        print("AFNOR: B 03 couvre aussi bien l'EN 1991-1-2 que l'EN 1995-1-1.")
        print("Il designe une famille, pas un document, et ne sert donc pas a")
        print("commander. La reference « NBN EN <norme> ANB », elle, suffit.")
        print()
        print("La forme « NBN EN <norme> ANB » se verifie sur les 24 annexes")
        print("detenues, avec UNE variation typographique: NBN EN 1991-1-2-ANB")
        print("s'ecrit avec un tiret la ou les autres mettent une espace.")
        print()
        print("Les couvertures ont DEUX formats selon l'epoque:")
        print("  2007-2013  « NBN EN X ANB Norme belge 1e ed., <mois> <annee> »")
        print("  2021+      « Norme belge NBN EN X ANB:<annee> ... Valable a")
        print("             partir de JJ-MM-AAAA ... Remplace NBN EN X ANB:AAAA »")
        print()
        print("Le second format NOMME l'edition qu'il remplace. C'est plus que")
        print("ce qu'imprime l'AFNOR, et ca permet de detecter mecaniquement")
        print("qu'un exemplaire detenu est devenu perime.")
        print()
        print("A verifier au passage sur chaque fiche produit:")
        print("  * L'EDITION. Deux cas averes dans ce depot: NBN EN 1990 ANB")
        print("    2021 remplace 2013, et NBN EN 1997-1 ANB 2022 remplace 2014.")
        print("    Verifier l'edition en vigueur avant toute commande.")
